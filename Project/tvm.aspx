<%@ Page Title="tvm" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tvm.aspx.cs" Inherits="Project.tvm" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" class="table table-striped table-dark text-center" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ></asp:GridView>
   </div>
    </section>
    ...
    <div class="container">
        ...
        <asp:GridView ID="GridView2" runat="server" class="table table-striped table-dark text-center" OnSelectedIndexChanged="GridView2_SelectedIndexChanged1"></asp:GridView>
    </div>
</section>
